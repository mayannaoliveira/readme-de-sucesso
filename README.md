...
<a href="https://github.com/mayannaoliveira/readme-de-sucesso/network/members"><img src="https://img.shields.io/github/forks/mayannaoliveira/readme-de-sucesso" alt="Forks Badge"/></a>
<a href="https://github.com/mayannaoliveira/readme-de-sucesso/pulls"><img src="https://img.shields.io/github/issues-pr/mayannaoliveira/readme-de-sucesso" alt="Pull Requests Badge"/></a>
<a href="https://github.com/mayannaoliveira/readme-de-sucesso/issues"><img src="https://img.shields.io/github/issues/mayannaoliveira/readme-de-sucesso" alt="Issues Badge"/></a>
<a href="https://github.com/mayannaoliveira/readme-de-sucesso/contributors"><img alt="GitHub contributors" src="https://img.shields.io/github/contributors/mayannaoliveira/readme-de-sucesso?color=2b9348"></a>
</p>
...
<div class="row" align="left">
  <div class="column">
    <img src="./img/action_1.png" style="width:70%">
    <img src="./img/action_2.png" style="width:70%">
  </div>
</div>
...
Seguir exemplo do [WakaTime coding metrics on your profile readme](https://github.com/athul/waka-readme) que foi elaborado pelo usuário [athul](https://github.com/athul).
...
A chave da API do WakaTime pode ser encontrada no link [Wakatime API Key](https://wakatime.com/api-key/). Após adicionar as actions será nescessário inserir a chave da API do Todoist, passo-a-passo:
...
3. Criar um novo `Secrets` de nome `WAKATIME_API_KEY` e inserir em `Value` a chave da sua API.
...
Chave da API do Todoist, segui tutorial [Encontre seu token API](https://todoist.com/pt-BR/help/articles/find-your-api-token-Jpzx9IIlB):

1. Faça login no Todoist no aplicativo web via [Todoist](https://todoist.com).
...
3. Criar um novo `Secrets` de nome `TODOIST_API_KEY` e inserir em `Value` a chave da sua API.
...
[OSS Insight](https://next.ossinsight.io/widgets?utm_source=github&utm_medium=referral) é mais uma opção para exibir o stats do seu perfil.
